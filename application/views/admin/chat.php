		...
		<div id="chat" class="fixed" data-current-user="Art Ramadani" data-order-by-status="1"
			...
			<div class="chat-conversation">
				...
				<div class="chat-textarea autocomplete="off""> <textarea autocomplete="off" class="form-control autogrow"
						placeholder="Type your message"></textarea autocomplete="off"> </div>
			</div>
		</div> <!-- Chat Histories -->
